...
#__Copyright__ = "Copyright Oct, 2021, Information Propagation Delay Modeling Project"
#__License__ = "None"
#__Version__ = "1.0.1"
...
plt.plot(xdata,ydata,label=["Avg prop delay is ",prop_delay,"days"])
